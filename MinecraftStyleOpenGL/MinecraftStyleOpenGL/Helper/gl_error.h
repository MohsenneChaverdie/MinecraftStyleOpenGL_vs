#ifndef PLAYINGWITHOPENGL_ESS_REVIEW_GL_ERROR_H
#define PLAYINGWITHOPENGL_ESS_REVIEW_GL_ERROR_H
...
namespace Helper
{
    // a helper error class, that makes it possible to debug OpenGL
    inline void error(const std::string &tmsg)
    {
...
#endif //PLAYINGWITHOPENGL_ESS_REVIEW_GL_ERROR_H
